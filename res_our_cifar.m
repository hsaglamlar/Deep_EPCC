function [net, info] = res_our_cifar(n, varargin)
...
opts.train.learningRate = [0.001*ones(1,5) 0.0001*ones(1,20) 0.00001*ones(1,25)] ;
...
%  imdb = opts.imdb;
%end
load('dataset/cifar10/cifar10_imdb_new.mat');
