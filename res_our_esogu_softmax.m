function [net, info] = res_our_esogu_softmax(n, varargin)
...
opts.train.learningRate = [0.01*ones(1,10) 0.001*ones(1,30)]; 
...
net2 = load('data/models/imagenet-resnet-101-dag.mat');
...
%  imdb = opts.imdb;
%end
load('/home/mlcv/yedekdisk/image_sets_experiments/ijba_imdb1.mat');
