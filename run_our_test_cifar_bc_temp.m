...
% loading cifar model
load('test_batch.mat')
net_path = '/home/mlcv/Desktop/ResNet-Matconvnet/data/exp/cifar10-resnet-101/net-epoch-1.mat';
...
batchsize = 20;
fd = ['/home/mlcv/Desktop/ResNet-Matconvnet/dataset/cifar10/cifar_images/1/'];
ss = 0;
%net.mode = 'normal';
net.mode = 'test' ;
    ...
    for j=1:batchsize,
        ...
        if ~isempty(opts.averageImage)
           ...
           % offset = reshape(offset,1,1,3);
            imtemp(:,:,:,ss) = bsxfun(@minus, single(imt(sx,sy,:)), offset) ;
            
        end
       % imtemp(:,:,:,ss) = single(imt(sx,sy,:));
