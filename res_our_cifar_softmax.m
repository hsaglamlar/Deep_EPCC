function [net, info] = res_our_cifar_softmax(n, varargin)
...
opts.train.learningRate = [0.001*ones(1,110)]; 
...
net2 = load('data/model/imagenet-resnet-101-dag.mat');
...
%  imdb = opts.imdb;
%end
load('dataset/cifar10/cifar10_imdb.mat');
